        ...
        <div className="md:p-8 p-4">
          ...
          <div className="p-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
            ...
            <p>¡Transforma tu dormitorio en un santuario de descanso y estilo con nuestra exclusiva colección de muebles de dormitorio de lujo!
              <p><strong>1-Canapé Abatible:</strong>Experimenta la comodidad suprema con nuestro canapé abatible de diseño elegante. Este versátil mueble combina la funcionalidad de un amplio espacio de almacenamiento con la elegancia de un diseño moderno y refinado. Con su mecanismo de elevación, acceder a tus pertenencias nunca había sido tan fácil. Disponible en una variedad de acabados y tamaños para adaptarse a tus necesidades y gustos personales.
                <p><strong>2-Colchón Hybrid:</strong>Sumérgete en un profundo sueño reparador con nuestro colchón Hybrid de última generación. Este colchón combina lo mejor de dos mundos: la suavidad y la adaptabilidad de la espuma viscoelástica con el soporte y la durabilidad de los muelles ensacados. Experimenta un confort inigualable y un descanso óptimo todas las noches. Disponible en diferentes tamaños para adaptarse a tu cama y preferencias de firmeza
                  <p><strong>3-Mesita de Noche:</strong>Añade un toque de elegancia funcional a tu dormitorio con nuestra mesita de noche de diseño contemporáneo. Con su superficie amplia y cajón espacioso, esta mesita de noche es el complemento perfecto para tu cama. Mantén a mano tus libros, dispositivos electrónicos y otros objetos esenciales mientras añades un toque de estilo a tu espacio de descanso. Disponible en una variedad de acabados para combinar con tu decoración existente.</p>
                </p>
              </p>
            </p>
          </div>
